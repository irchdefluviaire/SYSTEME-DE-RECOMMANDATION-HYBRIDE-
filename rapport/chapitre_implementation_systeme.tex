...
\begin{figure}[H]
  ...
  \source{Schéma de synthèse construit à partir du schéma PostgreSQL et des index pgvector du projet}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.3\textwidth}
    ...
    \caption*{\small (a) Types de noeuds}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\textwidth]{relations_neo4j.png}
    \caption*{\small (b) Types de relations}
  \end{minipage}
  ...
  \source{Schémas de synthèse construits à partir de la base Neo4j du projet}
\end{figure}
