...
La projection PCA ne doit pas être interprétée comme une carte exacte du sens ; elle compresse un espace de 384 dimensions en deux axes. C'est précisément pour cela que la figure indique la variance expliquée. Dans l'échantillon indexé, le premier axe porte 5,8\,\% de l'information, le deuxième 4,4\,\%, soit seulement 10,2\,\% pour le plan factoriel. Le nuage 2D est donc un diagnostic de structure, pas une preuve complète de séparation sémantique. Il montre surtout que les entités ne sont pas totalement écrasées dans une masse indifférenciée, tout en rappelant que l'essentiel de l'information reste dans les dimensions non représentées. Pour le retrieval, les mesures de ranking et les similarités cosinus restent donc plus probantes que la seule projection PCA.
