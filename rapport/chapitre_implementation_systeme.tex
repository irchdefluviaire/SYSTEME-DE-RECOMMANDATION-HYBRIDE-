...
\subsection{Degrés, hubs et compétences centrales}
...
\subsection{Communautés, connectivité et robustesse}
...
\subsection{Analyse métier et skill gap}
...
Le \textit{skill gap} a été mesuré sur un échantillon de couples candidat--offre en comparant les compétences \texttt{REQUIERT} de l'offre aux compétences \texttt{POSSEDE} du candidat. Le déficit moyen est de 5,32 compétences, avec une médiane de 6 ; seulement 12,33\,\% des couples échantillonnés ont un déficit inférieur ou égal à trois compétences. Ce résultat est dur, mais utile : le graphe ne dit pas que la majorité des candidats sont immédiatement compatibles avec une offre prise au hasard. Il montre au contraire que le matching doit sélectionner, filtrer et reranker. C'est précisément la raison d'être du moteur hybride : utiliser pgvector pour présélectionner des couples plausibles, puis Neo4j pour mesurer finement les compétences acquises, manquantes et passerelles.
