...
\end{itemize}
La stratégie de secours par fenêtres glissantes n'a pas été utilisée dans l'index courant.
...
\begin{figure}[H]
	...
	\begin{minipage}{0.32\textwidth}
		\centering
		\includegraphics[width=0.94\linewidth,height=0.18\textheight,keepaspectratio]{noeuds_neo4j.png}
		\caption*{(a) Types de noeuds}
	\end{minipage}
	\hfill
	\begin{minipage}{0.32\textwidth}
		\centering
		\includegraphics[width=0.98\linewidth,height=0.18\textheight,keepaspectratio]{sys.png}
		\caption*{(b) Répartition globale}
	\end{minipage}
	\hfill
	\begin{minipage}{0.32\textwidth}
		\centering
		\includegraphics[width=0.94\linewidth,height=0.18\textheight,keepaspectratio]{relations_neo4j.png}
		\caption*{(c) Types de relations}
	\end{minipage}
	
	\source{Nos travaux, diagnostics Neo4j à partir du graphe de connaissances emploi-compétences.}
\end{figure}
