...
\section{Architecture générale et périmètre implémenté}
...
\section{Données exploitées et diagnostic descriptif du corpus}

\subsection{Description statistique du corpus exploité}
...
\subsection{Qualité et disponibilité des informations utiles}
...
\subsection{Structure sectorielle des offres}
...
\subsection{Répartition géographique des opportunités}
...
\subsection{Niveaux de formation et expérience demandés}
...
\subsection{Structure des profils candidats}
...
\subsection{Compétences fréquentes dans les offres}
...
\subsection{Richesse textuelle des représentations utilisées}
...
\subsection{Équilibre macro entre offres et profils}
...
\subsection{Intégration des référentiels métiers et formations}
...
\section{Implémentation des briques de recherche et de recommandation}
...
\subsection{Moteur hybride de recommandation}
...
\subsection{Analyse du \textit{skill gap} et montée en compétences}
...
\section{Orchestration, interfaces et validation d'intégration}

\subsection{Orchestration agentique et génération contrôlée}
...
\subsection{Interfaces d'utilisation}
