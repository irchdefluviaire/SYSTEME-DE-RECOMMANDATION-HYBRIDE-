...
\begin{figure}[H]
	...
	\begin{minipage}{0.32\textwidth}
		\centering
		\includegraphics[width=0.5\linewidth]{noeuds_neo4j.png}
		\caption*{(a) Types de noeuds}
	\end{minipage}
	\hfill
	\begin{minipage}{0.32\textwidth}
		\centering
		\includegraphics[width=0.99\linewidth]{sys.png}
		\caption*{(b) Répartition globale}
	\end{minipage}
	\hfill
	\begin{minipage}{0.32\textwidth}
		\centering
		\includegraphics[width=0.5\linewidth]{relations_neo4j.png}
