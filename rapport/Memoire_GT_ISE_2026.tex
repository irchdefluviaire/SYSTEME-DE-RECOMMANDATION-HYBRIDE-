...
\begin{itemize}
    ...
    \item générer des verdicts interprétables de matching — profil prêt, profil avec plan de montée en compétence, profil en vivier, profil hors cible — assortis d'une analyse de \emph{skill gap} et évalués par les métriques Recall@K, NDCG@K, MRR@K et MAP@K.
\end{itemize}
