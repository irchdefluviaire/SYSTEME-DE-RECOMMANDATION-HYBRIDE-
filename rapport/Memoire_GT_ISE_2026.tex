...
Le seuil opérationnel retenu est 0,46. À ce niveau, aucune réponse associée à un contexte mélangé n'est acceptée dans le test contrastif, tandis que 50 réponses sur 51 restent acceptées avec leur vrai contexte. La règle choisie est donc prudente : elle préfère déclencher une révision inutile plutôt que laisser passer une réponse déconnectée de ses preuves.
