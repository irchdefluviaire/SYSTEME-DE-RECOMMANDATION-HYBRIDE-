...
\centering
\textit{\textbf{Comment proposer et opérationnaliser un pipeline de recommandation emploi--compétences par recherche hybride, combinant rappel sémantique, vérification par graphe de connaissances et génération contrôlée par \LLM{}, afin de produire des classements traçables et des explications fondées sur des preuves ?}}
\end{tcolorbox}
\end{center}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{p{3.0cm}p{3.4cm}X}
    ...
    \midrule
    Offres d'emploi & Données opérationnelles collectées par KmerAI et FNE & Normalisation, extraction de compétences, génération de \filevar{text\_to\_embed}, indexation vectorielle, création des noeuds d'offres et calcul des scores de matching. \\
...
\includegraphics[width=0.92\textwidth]{figures/generated/evaluation/hybrid_weights_multi_objective_comparison.png}\par\vspace{0.45cm}
\includegraphics[width=0.92\textwidth]{figures/generated/evaluation/hybrid_weights_ndcg_comparison_ndcg.png}
