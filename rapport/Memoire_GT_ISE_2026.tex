...
Deux précautions guident l'interprétation. Premièrement, l'évaluation du classement est conduite sans génération \LLM{} : elle mesure la qualité du retrieval et du reranking, non la qualité rédactionnelle de la réponse. Deuxièmement, la pertinence utilisée dans l'ablation est un proxy construit à partir des métadonnées normalisées ; elle permet de comparer deux variantes du même système, mais ne remplace pas une annotation humaine par des recruteurs ou des conseillers métier.
