...
\begin{itemize}
    ...
    \item \textbf{H4 :} La combinaison d'un RAG agentic et d'un score de recommandation hybride améliore la pertinence et l'explicabilité des recommandations de \emph{skill gap} et de parcours de montée en compétences.
\end{itemize}
\vspace{-0.5cm}
...
\includegraphics[width=0.52\textwidth]{figures/generated/evaluation/functional_graph_evaluation.png}
...
\midrule
H1 & Unification des référentiels métiers--compétences--formations & Soutenue partiellement & Les référentiels structurent les variables utiles au matching et au \textit{skill gap}. L'effet propre de chaque référentiel n'a toutefois pas été isolé par ablation séparée. \\
H2 & Apport du graphe Neo4j face au vectoriel seul & Soutenue & L'ablation montre une hausse du NDCG@10 de 0.5575 à 0.7392 et du MRR@10 de 0.6908 à 0.8093 après reranking relationnel. \\
H3 & Apport du fine-tuning des embeddings & Soutenue & Le modèle adapté obtient de meilleurs scores de ranking que le modèle de départ et devient l'encodeur principal du retrieval pgvector. \\
H4 & Agentic RAG et score hybride pour explicabilité et \textit{skill gap} & Soutenue avec prudence & Le workflow LangGraph orchestre les outils et produit des réponses traçables. La qualité métier finale doit encore être validée par des experts humains. \\
\bottomrule
\end{tabularx}
\tableStyleEnd
...
La lecture globale est donc favorable au système hybride, mais elle ne doit pas être surinterprétée. Les hypothèses H2 et H3 sont les plus solidement appuyées, car elles reposent sur des comparaisons quantitatives directes. Les hypothèses H1 et H4 sont également cohérentes avec les résultats, mais elles dépendent davantage de la qualité des référentiels, du graphe construit et de futures validations utilisateur.
