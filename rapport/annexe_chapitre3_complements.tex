% Compléments détaillés déplacés depuis le chapitre 3 pour alléger le corps du mémoire.
\section{Compléments techniques du chapitre 3}

Les éléments suivants documentent les diagnostics détaillés de l'implémentation. Ils sont conservés en annexe afin que le chapitre 3 reste centré sur les décisions d'architecture et non sur l'inventaire complet des sorties graphiques.
