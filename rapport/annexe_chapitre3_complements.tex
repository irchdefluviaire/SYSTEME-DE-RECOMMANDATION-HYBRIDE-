...
\begin{figure}[H]
	...
	\includegraphics[width=0.54\textwidth]{figures/generated/implementation_deep_current/02_localisation_mixte.png}
	\source{Nos travaux, traitements Python de nettoyage et de diagnostic, à partir des données collectées du projet.}
\end{figure}
\begin{table}[H]
  \centering
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.5\textwidth]{figures/generated/implementation_deep_current/08_neo4j_composition.png}
